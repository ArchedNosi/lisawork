		...
		try (Scanner reader = new Scanner(System.in)) {
			...
			if (entityCount == 2) {
				...
				for (C4entity entity : entities) {
					System.out.println(entity.arcLog + "Hit " + entity.totalHitsSum + " times total out of " + entity.totalAttempts + " | (" + round((100*(double)entity.totalHitsSum/entity.totalAttempts)) + "%)");
				}
			}
			//-----
			if (entityCount >= 3) {
